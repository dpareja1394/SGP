...
import com.dsdsoft.sgp.modelo.mapper.IProyectoMapper;
...
public class BusinessDelegatorView implements IBusinessDelegatorView {
	...
	public List<Actividad> findByCriteriaInActividad(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return actividadLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Actividad> findPageActividad(String sortColumnName, boolean sortAscending, int startRow, int maxResults)
			throws Exception {
		return actividadLogic.findPageActividad(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<CasoSoporte> findByCriteriaInCasoSoporte(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return casoSoporteLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<CasoSoporte> findPageCasoSoporte(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return casoSoporteLogic.findPageCasoSoporte(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<Cliente> findByCriteriaInCliente(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return clienteLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Cliente> findPageCliente(String sortColumnName, boolean sortAscending, int startRow, int maxResults)
			throws Exception {
		return clienteLogic.findPageCliente(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<EstadoHistoriaUsuario> getEstadoHistoriaUsuario() throws Exception {
		return estadoHistoriaUsuarioLogic.getEstadoHistoriaUsuario();
	}

	public void saveEstadoHistoriaUsuario(EstadoHistoriaUsuario entity) throws Exception {
		estadoHistoriaUsuarioLogic.saveEstadoHistoriaUsuario(entity);
	}

	public void deleteEstadoHistoriaUsuario(EstadoHistoriaUsuario entity) throws Exception {
		estadoHistoriaUsuarioLogic.deleteEstadoHistoriaUsuario(entity);
	}

	public void updateEstadoHistoriaUsuario(EstadoHistoriaUsuario entity) throws Exception {
		estadoHistoriaUsuarioLogic.updateEstadoHistoriaUsuario(entity);
	}

	public EstadoHistoriaUsuario getEstadoHistoriaUsuario(Integer eshiId) throws Exception {
	...
	public List<EstadoHistoriaUsuario> findByCriteriaInEstadoHistoriaUsuario(Object[] variables,
			Object[] variablesBetween, Object[] variablesBetweenDates) throws Exception {
		return estadoHistoriaUsuarioLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<EstadoHistoriaUsuario> findPageEstadoHistoriaUsuario(String sortColumnName, boolean sortAscending,
			int startRow, int maxResults) throws Exception {
		return estadoHistoriaUsuarioLogic.findPageEstadoHistoriaUsuario(sortColumnName, sortAscending, startRow,
				maxResults);
	}

	public Long findTotalNumberEstadoHistoriaUsuario() throws Exception {
		return estadoHistoriaUsuarioLogic.findTotalNumberEstadoHistoriaUsuario();
	}

	public List<EstadoHistoriaUsuarioDTO> getDataEstadoHistoriaUsuario() throws Exception {
	...
	public void saveEstadoProyecto(EstadoProyecto entity) throws Exception {
		estadoProyectoLogic.saveEstadoProyecto(entity);
	}

	public void deleteEstadoProyecto(EstadoProyecto entity) throws Exception {
		estadoProyectoLogic.deleteEstadoProyecto(entity);
	}

	public void updateEstadoProyecto(EstadoProyecto entity) throws Exception {
		estadoProyectoLogic.updateEstadoProyecto(entity);
	}

	public EstadoProyecto getEstadoProyecto(Integer esprId) throws Exception {
	...
	public List<EstadoProyecto> findByCriteriaInEstadoProyecto(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return estadoProyectoLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<EstadoProyecto> findPageEstadoProyecto(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return estadoProyectoLogic.findPageEstadoProyecto(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<EstadoProyectoDTO> getDataEstadoProyecto() throws Exception {
		return estadoProyectoLogic.getDataEstadoProyecto();
	}

	public List<HistoriaDeUsuario> getHistoriaDeUsuario() throws Exception {
		return historiaDeUsuarioLogic.getHistoriaDeUsuario();
	}

	public void saveHistoriaDeUsuario(HistoriaDeUsuario entity) throws Exception {
		historiaDeUsuarioLogic.saveHistoriaDeUsuario(entity);
	}

	public void deleteHistoriaDeUsuario(HistoriaDeUsuario entity) throws Exception {
		historiaDeUsuarioLogic.deleteHistoriaDeUsuario(entity);
	}

	public void updateHistoriaDeUsuario(HistoriaDeUsuario entity) throws Exception {
		historiaDeUsuarioLogic.updateHistoriaDeUsuario(entity);
	}

	public HistoriaDeUsuario getHistoriaDeUsuario(Integer hiusId) throws Exception {
	...
	public List<HistoriaDeUsuario> findByCriteriaInHistoriaDeUsuario(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return historiaDeUsuarioLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<HistoriaDeUsuario> findPageHistoriaDeUsuario(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return historiaDeUsuarioLogic.findPageHistoriaDeUsuario(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<HistoriaDeUsuarioDTO> getDataHistoriaDeUsuario() throws Exception {
	...
	public List<Proyecto> findByCriteriaInProyecto(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return proyectoLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Proyecto> findPageProyecto(String sortColumnName, boolean sortAscending, int startRow, int maxResults)
			throws Exception {
		return proyectoLogic.findPageProyecto(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<ProyectoUsuarioRol> getProyectoUsuarioRol() throws Exception {
		return proyectoUsuarioRolLogic.getProyectoUsuarioRol();
	}

	public void saveProyectoUsuarioRol(ProyectoUsuarioRol entity) throws Exception {
		proyectoUsuarioRolLogic.saveProyectoUsuarioRol(entity);
	}

	public void deleteProyectoUsuarioRol(ProyectoUsuarioRol entity) throws Exception {
		proyectoUsuarioRolLogic.deleteProyectoUsuarioRol(entity);
	}

	public void updateProyectoUsuarioRol(ProyectoUsuarioRol entity) throws Exception {
		proyectoUsuarioRolLogic.updateProyectoUsuarioRol(entity);
	}

	public ProyectoUsuarioRol getProyectoUsuarioRol(ProyectoUsuarioRolId id) throws Exception {
	...
	public List<ProyectoUsuarioRol> findByCriteriaInProyectoUsuarioRol(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return proyectoUsuarioRolLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<ProyectoUsuarioRol> findPageProyectoUsuarioRol(String sortColumnName, boolean sortAscending,
			int startRow, int maxResults) throws Exception {
		return proyectoUsuarioRolLogic.findPageProyectoUsuarioRol(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<ProyectoUsuarioRolDTO> getDataProyectoUsuarioRol() throws Exception {
	...
	public void saveRequerimiento(Requerimiento entity) throws Exception {
		requerimientoLogic.saveRequerimiento(entity);
	}

	public void deleteRequerimiento(Requerimiento entity) throws Exception {
		requerimientoLogic.deleteRequerimiento(entity);
	}

	public void updateRequerimiento(Requerimiento entity) throws Exception {
		requerimientoLogic.updateRequerimiento(entity);
	}

	public Requerimiento getRequerimiento(Integer requId) throws Exception {
	...
	public List<Requerimiento> findByCriteriaInRequerimiento(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return requerimientoLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Requerimiento> findPageRequerimiento(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return requerimientoLogic.findPageRequerimiento(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<RequerimientoDTO> getDataRequerimiento() throws Exception {
	...
	public List<Rol> findByCriteriaInRol(Object[] variables, Object[] variablesBetween, Object[] variablesBetweenDates)
			throws Exception {
		return rolLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Rol> findPageRol(String sortColumnName, boolean sortAscending, int startRow, int maxResults)
			throws Exception {
	...
	public void saveSeguimientoCaso(SeguimientoCaso entity) throws Exception {
		seguimientoCasoLogic.saveSeguimientoCaso(entity);
	}

	public void deleteSeguimientoCaso(SeguimientoCaso entity) throws Exception {
		seguimientoCasoLogic.deleteSeguimientoCaso(entity);
	}

	public void updateSeguimientoCaso(SeguimientoCaso entity) throws Exception {
		seguimientoCasoLogic.updateSeguimientoCaso(entity);
	}

	public SeguimientoCaso getSeguimientoCaso(Integer secaId) throws Exception {
	...
	public List<SeguimientoCaso> findByCriteriaInSeguimientoCaso(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return seguimientoCasoLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<SeguimientoCaso> findPageSeguimientoCaso(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return seguimientoCasoLogic.findPageSeguimientoCaso(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<SeguimientoCasoDTO> getDataSeguimientoCaso() throws Exception {
	...
	public void saveTipoActividad(TipoActividad entity) throws Exception {
		tipoActividadLogic.saveTipoActividad(entity);
	}

	public void deleteTipoActividad(TipoActividad entity) throws Exception {
		tipoActividadLogic.deleteTipoActividad(entity);
	}

	public void updateTipoActividad(TipoActividad entity) throws Exception {
		tipoActividadLogic.updateTipoActividad(entity);
	}

	public TipoActividad getTipoActividad(Integer tiacId) throws Exception {
	...
	public List<TipoActividad> findByCriteriaInTipoActividad(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return tipoActividadLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<TipoActividad> findPageTipoActividad(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return tipoActividadLogic.findPageTipoActividad(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<TipoActividadDTO> getDataTipoActividad() throws Exception {
	 ...
	 * @version may. 28, 2019
	 *
	 * @see com.dsdsoft.sgp.presentation.businessDelegate.IBusinessDelegatorView#consultarHistoriasUsuarioPorFiltros(java.lang.Integer,
	...
	public List<HistoriaDeUsuarioDTO> consultarHistoriasUsuarioPorFiltros(Integer usuaId, Integer proyId,
		...
		return historiaDeUsuarioLogic.consultarHistoriasUsuarioPorFiltros(usuaId, proyId, requId, eshiId);
	}
	 ...
	 * @version ago. 06, 2019
	 *
	 * @see com.dsdsoft.sgp.presentation.businessDelegate.IBusinessDelegatorView#toProyectoDTO(com.dsdsoft.sgp.modelo.Proyecto)
	 *
	 */
	@Override
	public ProyectoDTO toProyectoDTO(Proyecto proyecto) throws Exception {
	 ...
	 * @version ago. 06, 2019
	 *
	 * @see com.dsdsoft.sgp.presentation.businessDelegate.IBusinessDelegatorView#toProyecto(com.dsdsoft.sgp.modelo.dto.ProyectoDTO)
	 *
	 */
	@Override
	public Proyecto toProyecto(ProyectoDTO proyectoDTO) throws Exception {
		return proyectoMapper.toEntity(proyectoDTO);
	}
	 ...
	 * @version ago. 06, 2019
	 *
	 * @see com.dsdsoft.sgp.presentation.businessDelegate.IBusinessDelegatorView#toProyectoDTOList(java.util.List)
	 *
	 */
	@Override
	public List<ProyectoDTO> toProyectoDTOList(List<Proyecto> listProyecto) throws Exception {
		return proyectoMapper.toDTOList(listProyecto);
	}
	 ...
	 * @version ago. 06, 2019
	 *
	 * @see com.dsdsoft.sgp.presentation.businessDelegate.IBusinessDelegatorView#toProyectoList(java.util.List)
	 *
	 */
	@Override
	public List<Proyecto> toProyectoList(List<ProyectoDTO> listProyectoDTO) throws Exception {
