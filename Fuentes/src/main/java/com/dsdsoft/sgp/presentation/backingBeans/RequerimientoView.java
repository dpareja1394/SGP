...
public class RequerimientoView implements Serializable {
	...
	public InputText getTxtTituloRequerimiento() {
		return txtTituloRequerimiento;
	}

	public void setTxtTituloRequerimiento(InputText txtTituloRequerimiento) {
		this.txtTituloRequerimiento = txtTituloRequerimiento;
	}

	public InputTextarea getTxtAreaDescripcionRequerimiento() {
		return txtAreaDescripcionRequerimiento;
	}

	public void setTxtAreaDescripcionRequerimiento(InputTextarea txtAreaDescripcionRequerimiento) {
		this.txtAreaDescripcionRequerimiento = txtAreaDescripcionRequerimiento;
	}
	...
	public void listener_txtId() {
		try {
			Integer requId = FacesUtils.checkInteger(txtRequId);
			entity = (requId != null) ? businessDelegatorView.getRequerimiento(requId) : null;
		} catch (Exception e) {
			entity = null;
		}
	...
	public String action_edit(ActionEvent evt) {
		selectedRequerimiento = (RequerimientoDTO) (evt.getComponent().getAttributes().get("selectedRequerimiento"));
	...
	public String action_create() {
		try {
			...
			entity.setDescripcionRequerimiento(FacesUtils.checkString(txtDescripcionRequerimiento));
			entity.setNombreRequerimiento(FacesUtils.checkString(txtNombreRequerimiento));
			entity.setRequId(requId);
			entity.setProyecto((FacesUtils.checkInteger(txtProyId_Proyecto) != null)
					? businessDelegatorView.getProyecto(FacesUtils.checkInteger(txtProyId_Proyecto)) : null);
	...
	public String action_delete_datatable(ActionEvent evt) {
		try {
			selectedRequerimiento = (RequerimientoDTO) (evt.getComponent().getAttributes()
	...
	public String action_modifyWitDTO(String descripcionRequerimiento, String nombreRequerimiento, Integer requId,
			Integer proyId_Proyecto) throws Exception {
		try {
			entity.setDescripcionRequerimiento(FacesUtils.checkString(descripcionRequerimiento));
			entity.setNombreRequerimiento(FacesUtils.checkString(nombreRequerimiento));
			businessDelegatorView.updateRequerimiento(entity);
			FacesUtils.addInfoMessage(ZMessManager.ENTITY_SUCCESFULLYMODIFIED);
		} catch (Exception e) {
	...
	public void setTxtDescripcionRequerimiento(InputText txtDescripcionRequerimiento) {
	...
	public List<RequerimientoDTO> getRequerimientosPorProyecto() {
		...
		return requerimientosPorProyecto;
	}

	public void setRequerimientosPorProyecto(List<RequerimientoDTO> requerimientosPorProyecto) {
		this.requerimientosPorProyecto = requerimientosPorProyecto;
	}
