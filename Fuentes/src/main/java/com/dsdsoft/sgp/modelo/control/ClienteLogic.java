...
public class ClienteLogic implements IClienteLogic {
    ...
    */
        ...
        try {
            ...
            if ((entity.getCelularContacto() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getCelularContacto(), 200) == false)) {
            ...
            if ((entity.getDireccionContacto() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getDireccionContacto(), 200) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "direccionContacto");
            }
            ...
            if ((entity.getEnlaceWeb() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getEnlaceWeb(), 200) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "enlaceWeb");
            }

            if ((entity.getNit() != null) &&
                    (Utilities.checkWordAndCheckWithlength(entity.getNit(), 30) == false)) {
            ...
            if ((entity.getNombreContacto() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getNombreContacto(), 200) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "nombreContacto");
            }
            ...
            if ((entity.getNombreEmpresa() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getNombreEmpresa(), 200) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "nombreEmpresa");
            }
            ...
            if ((entity.getTelefonoContacto() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getTelefonoContacto(), 20) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "telefonoContacto");
            }
    ...
    public void deleteCliente(Cliente entity) throws Exception {
        ...
        try {
            proyectos = proyectoDAO.findByProperty("cliente.clieId",
                    entity.getClieId());
    ...
    public List<ClienteDTO> getDataCliente() throws Exception {
        try {
            ...
            for (Cliente clienteTmp : cliente) {
                ...
                clienteDTO2.setCelularContacto((clienteTmp.getCelularContacto() != null)
                    ? clienteTmp.getCelularContacto() : null);
                clienteDTO2.setDireccionContacto((clienteTmp.getDireccionContacto() != null)
                    ? clienteTmp.getDireccionContacto() : null);
                clienteDTO2.setEnlaceWeb((clienteTmp.getEnlaceWeb() != null)
                    ? clienteTmp.getEnlaceWeb() : null);
                clienteDTO2.setNit((clienteTmp.getNit() != null)
                    ? clienteTmp.getNit() : null);
                clienteDTO2.setNombreContacto((clienteTmp.getNombreContacto() != null)
                    ? clienteTmp.getNombreContacto() : null);
                clienteDTO2.setNombreEmpresa((clienteTmp.getNombreEmpresa() != null)
                    ? clienteTmp.getNombreEmpresa() : null);
                clienteDTO2.setTelefonoContacto((clienteTmp.getTelefonoContacto() != null)
                    ? clienteTmp.getTelefonoContacto() : null);
